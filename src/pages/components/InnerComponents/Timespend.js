...
const Timespend = () => {
  ...
  const fetchSessionData = async () => {
    try {
      ...
      const apiEndpoints = {
        pdf: "https://admin-dashboard-backend-rust.vercel.app/api/v1/pdf/timespend",
        weblink: "https://admin-dashboard-backend-rust.vercel.app/api/v1/web/timespend",
        video: "https://admin-dashboard-backend-rust.vercel.app/api/v1/video/timespend",
        docx: "https://admin-dashboard-backend-rust.vercel.app/api/v1/docx/timespend",
      };
