...
const Device = () => {
  ...
  const fetchDeviceData = async () => {
    try {
      ...
      const apiEndpoints = {
        pdf: "https://admin-dashboard-backend-rust.vercel.app/api/v1/pdf/device",
        web: "https://admin-dashboard-backend-rust.vercel.app/api/v1/web/device",
        weblink: "https://admin-dashboard-backend-rust.vercel.app/api/v1/web/device",
        video: "https://admin-dashboard-backend-rust.vercel.app/api/v1/video/device",
        docx: "https://admin-dashboard-backend-rust.vercel.app/api/v1/docx/device",
      };
